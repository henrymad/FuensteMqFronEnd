...
export class DetailWeek {
    ...
    mondayDate: string;
    mondayApprove:any 
    mondayListBuilding:any[];
    tuesday: number;
    tuesdayDate: string;
    tuesdayApprove: any;
    tuesdayListBuilding:any[];
    wednesday: number;
    wednesdayDate: string;
    wednesdayApprove: any;
    wednesdayListBuilding:any[];
    thursday: number;
    thursdayDate: string;
    thursdayApprove: any;
    thursdayListBuilding:any[];
    friday: number;
    fridayDate: string;
    fridayApprove: any;
    fridayListBuilding:any[];
    saturday: number;
    saturdayDate: string;
    saturdayApprove: any;
    saturdayListBuilding:any[];
    sunday: number;
    sundayDate: any;
    sundayApprove: any;
    sundayListBuilding:any[];
